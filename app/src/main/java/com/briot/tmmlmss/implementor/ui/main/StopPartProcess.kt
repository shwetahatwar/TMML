...
//                viewModel.loadMachineDetails(stopPartMachineBarcodeScan.text.toString().toInt())
//
//
//                handled = true
//            }
...
//            if (i == EditorInfo.IME_ACTION_DONE || (keyEvent.keyCode == KeyEvent.KEYCODE_ENTER && keyEvent.action == KeyEvent.ACTION_DOWN)) {
//                this.progress = MainActivity.showProgressIndicator(this.activity as AppCompatActivity, "Please wait")
//                viewModel.loadJobcardDetails(stopPartJobcardBarcodeScan.text.toString().toInt())
//
//                handled = true
//            }
//            handled
...
//
//
////        stopPartEnterQuantity.setOnEditorActionListener { _, i, keyEvent ->
////            var handled = false
////            if (i == EditorInfo.IME_ACTION_DONE || (keyEvent.keyCode == KeyEvent.KEYCODE_ENTER && keyEvent.action == KeyEvent.ACTION_DOWN)) {
////                this.progress = MainActivity.showProgressIndicator(this.activity as AppCompatActivity, "Please wait")
////                viewModel.updateStopPartProcess(stopPartEnterQuantity.text.toString().toInt())
////
////                handled = true
////            }
////            handled
...
//            this.progress = MainActivity.showProgressIndicator(this.activity as AppCompatActivity, "Please wait")
//            viewModel.updateStopPartProcess(stopPartMachineBarcodeScan.text.toString().toInt(), stopPartJobcardBarcodeScan.text.toString().toInt(),stopPartEnterQuantity.text.toString().toInt(),stopPartProcessSpinner.toString(),stopPartProcessRemark.text.toString())
//
//        }
//
//    }
